class AddInitialCustomisationImages < ActiveRecord::Migration[6.0]
  def up
    ...
    Customisation.find_by(customisation_type: "dashboard_style", value: "yellow")
